...
import { Clock, BookOpen, GraduationCap, Timer, Package2, ArrowLeft } from 'lucide-react'
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h1 className="text-3xl font-bold mb-3">
            Other <span className="text-emerald-400">Package</span>{' '}
        ...
        >
          {loading
            ...
            : packages.map((pkg) => (
                ...
                >
                  <Card
                    className={`group bg-gray-900 border-gray-800 hover:border-gray-700 transition-all duration-300 h-full ${
                      selectedPackage === pkg.id ? "ring-2 ring-emerald-400" : ""
                    } ${
